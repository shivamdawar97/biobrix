...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 4, vars: 0, consts: [[1, "navbar-container"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
...
class ProductsComponent {
    constructor(route, router, dataService, cartService, productService) {
        this.route = route;
        this.router = router;
        this.dataService = dataService;
        this.cartService = cartService;
